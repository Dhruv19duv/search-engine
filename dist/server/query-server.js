...
class QueryServer {
    ...
    /** Handle autocomplete */
    async handleAutocomplete(res, params) {
    ...
    async handleSuggest(res, params) {
        const query = params.get('q');
        if (!query) {
            this.sendJSON(res, 200, { suggestions: [] });
            return;
